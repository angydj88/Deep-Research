...
def crear_dimensiones(objetivo: str) -> list[dict]:
    """Genera las 7 dimensiones con sus prompts."""
    ...
    return [
        {
            ...
            "prompt": (
                "Eres el mayor experto terminólogo del mundo.\n\n" + base +
                ...
                "6. **TÉRMINOS EN TENDENCIA 2024-2025**: Neologismos emergentes\n"
        ...
        },
        {
            ...
            "prompt": (
                "Eres el mayor analista económico y de mercados del mundo.\n\n" + base +
                ...
                "Incluye CIFRAS REALES de 2023-2025. Usa tablas."
            ),
        },
        {
            "num": 3,
            ...
            "prompt": (
                "Eres el mayor analista de datos y estadístico del mundo.\n\n" + base +
        ...
        },
        {
            ...
            "prompt": (
                "Eres el mayor analista sectorial del mundo.\n\n" + base +
                ...
                "8. **MOVIMIENTOS RECIENTES**: M&A, alianzas 2023-2025\n\n"
        ...
        },
        {
            ...
            "prompt": (
                "Eres el mayor estratega y consultor del mundo.\n\n" + base +
        ...
        },
        {
            ...
            "prompt": (
                "Eres el mayor analista de riesgos del mundo.\n\n" + base +
        ...
        },
        {
            ...
            "prompt": (
                "Eres el mayor futurista del mundo.\n\n" + base +
